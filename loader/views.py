...
logging.basicConfig(filemode="basic.log", level=logging.INFO)
...
def create_new_post_from_user_data_page():
    ...
    try:
        ...
        return "Неудалось сохранить файл, путь не найден"
    ...
    try:
        ...
        return "Неудалось добавить пост, ошибка записи в список постов"
